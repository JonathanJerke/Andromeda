...
double CanonicalRankDecomposition (  sinc_label  f0 ,double * coeff,   division origin,inta os,  division alloy,inta spin, double tolerance, double relativeTolerance, double condition,double threshold, inta maxCycle ,double maxCondition, inta canon ,inta X1){
    ...
    if ( f0.rt->boost )
        return CanonicalRankDecompositionBoost(f0, coeff, origin, os, alloy, spin, tolerance, relativeTolerance, condition, threshold, maxCycle, maxCondition, canon, X1);
    else
        return CanonicalRankDecompositionFibonacci(f0, coeff, origin, os, alloy, spin, tolerance, relativeTolerance, condition, threshold, maxCycle, maxCondition, canon);
};
 ...
 *@param maxCycle the maxmium number of cycles in this routine
*/
double CanonicalRankDecompositionBoost (  sinc_label  f0 ,double * coeff,   division origin,inta os,  division alloy,inta spin, double tolerance, double relativeTolerance, double condition,double threshold, inta maxCycle ,double maxCondition, inta canon ,inta X1){
    inta rank;
    division G = nullName;
 ...
 *@param maxCycle the maxmium number of cycles in this routine
*/
double CanonicalRankDecompositionFibonacci ( sinc_label  f1 ,double * coeff,   division origin,inta os,  division alloy,inta spin, double tolerance, double relativeTolerance, double condition,double threshold, inta maxCycle ,double maxCondition, inta canon ){
    inta rank;
    inta L1 = canon;
