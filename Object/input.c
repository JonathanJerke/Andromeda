                                ...
                                if ( f->f.canon[dim].body != nada)
                                    if ( f->f.canon[dim].basis == SincBasisElement || f->f.canon[dim].basis == PeriodicSincBasisElement){
                                        ...
                                        for (body1 = one ; body1 <= f->f.canon[dim].body; body1++){
                                            ...
                                            f->f.canon[dim].particle[body1].origin -= +f->f.canon[dim].particle[body1].lattice*(f->f.canon[dim].count1Basis+ivalue*f->f.canon[dim].count1Inc-1)*f->f.canon[dim].particle[body1].anchor;
