                            ...
                            
                        {
                            ...
                            if ( (((f.i.filter/2)%2)==1)*f.f.irrep ) {
                                ...
                                for ( sp = 0; sp < spins(f1, eigenVectors);sp++){
                                    ...
                                    CanonicalRankDecomposition( f2.f, NULL,totalVector, 0,eigenVectors,sp, f1.rt->TOLERANCE,f1.rt->relativeTOLERANCE, f1.rt->ALPHA,f1.rt->THRESHOLD, f1.rt->MAX_CYCLE,f1.rt->XCONDITION, part(f2.f,eigenVectors));
                                }
                            }
                        }
                            if ( collect ){
