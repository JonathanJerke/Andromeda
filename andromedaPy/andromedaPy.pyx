...
cdef class galaxy:
	...
	def full( self, g: galaxy ,  vector : division  = division.eigenVectors ):
		...
		g.field.f.name[int(division.eigenVectors)].chainNext = division.nullName
	...
	def compress ( self, g : galaxy , vector : division = division.eigenVectors):
		...
		canonicalRankCompression(spatial,NULL,self.field.f,0,NULL,division.eigenVectors,0,1,0,g.field.f,0,vector,0,1,0,
