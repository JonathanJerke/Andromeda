...
INT_TYPE tGEMV (INT_TYPE rank,  struct sinc_label  f1,INT_TYPE dim,  enum division equals, INT_TYPE espin,enum division left,INT_TYPE l,INT_TYPE lspin, enum division right, INT_TYPE r,INT_TYPE rspin );
