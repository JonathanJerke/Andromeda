...
INT_TYPE tBuildIrr ( INT_TYPE rank, struct sinc_label , char meta , enum division origin, INT_TYPE ospin, enum division targ , INT_TYPE tspin);
char matrixAction ( enum bodyType bd, enum block bk, char direction);
INT_TYPE tPermuteOne(INT_TYPE rank, struct sinc_label , INT_TYPE dim, char leftChar , enum division left, INT_TYPE l, INT_TYPE lspin, enum division equals, INT_TYPE espin);
INT_TYPE tPermute(INT_TYPE rank, struct sinc_label , char leftChar , enum division left, INT_TYPE lspin, enum division equals, INT_TYPE espin);
